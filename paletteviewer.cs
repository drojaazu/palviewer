...
/*
    PaletteViewer
    Windows forms component for viewing and working with 256 color palettes
    Author: Damian Rogers
    https://github.com/ryogamasaki
*/
...
public class PaletteViewer : UserControl {
    ...
    public int SubpaletteSize {
        ...
        set {
            ...
            if (this.linewidth != 256)
                this.subpalette = this.linewidth == 2 ? dumplib.Gfx.Palettes.NewPalette.New_1bit () : dumplib.Gfx.Palettes.NewPalette.New_4bit (true);
            this.Line = 0;
        }
    }
    ...
    public PaletteViewer () {
        ...
        this.fullpalette = dumplib.Gfx.Palettes.NewPalette.New_8bit ();
        this.subpalette = dumplib.Gfx.Palettes.NewPalette.New_4bit (true);
    }
    ...
    protected override void OnLoad (EventArgs e) {
        ...
        this.selectrect = new Rectangle (0, 0, this.tilesize * this.linewidth, this.tilesize);
        this.subpalette = this.linewidth == 2 ? dumplib.Gfx.Palettes.NewPalette.New_1bit () : dumplib.Gfx.Palettes.NewPalette.New_4bit ();
        this.DrawGrid ();
        this.DrawSelection ();
        this.DrawColorSelection ();
        this.Refresh ();
